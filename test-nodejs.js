// Test BotSight with Node.js website
...
async function testNodeJS() {
  ...
  console.log(`🔍 Testing Node.js Official Site: ${url}`);
  ...
  try {
    ...
    const outputDir = `test-results/nodejs-${timestamp}`;
    ...
    console.error(`❌ Error testing Node.js site:`, error.message);
    return {
      url,
      error: error.message
    };
